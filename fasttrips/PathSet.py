...
class PathSet:
    ...
    def calculate_cost(FT, STOCH_DISPERSION, pathset_paths_df, pathset_links_df, veh_trips_df, reset_bump_iter=False):
        ...
        if PathSet.LEARN_ROUTES:
            pathset_paths_df['learn_discount'] = (1+PathSet.LEARN_ROUTES_RATE)**pathset_paths_df['chosen_count']-1
            pathset_paths_df['orig_sim_cost'] = pathset_paths_df[Assignment.SIM_COL_PAX_COST]
            pathset_paths_df[Assignment.SIM_COL_PAX_COST] = pathset_paths_df[Assignment.SIM_COL_PAX_COST] * (1-pathset_paths_df['learn_discount'])
